...
namespace
{
    ...
    public:
        ...
        void setup(double plot_duration_sec)
        {
            ...
            SetupAxisLimits(ImAxis_Y1, min_y_, max_y_, ImGuiCond_Always);
        ...
        void plot(double plot_duration_sec)
        {
            ...
            PlotHeatmap(
                ...
                ImPlotPoint{
                    ts_view_[0],
                    min_y_}, // coordinate of view in unit of limits
                ImPlotPoint{
                    ts_view_[plot_length_ - 1],
                    max_y_},                // coordinate of view in unit of limits
    ...
    public:
        SpectrogramPlot(
            ...
            int height,
            D *data)
            : name_(name), width_(width), height_(height), data_(data), plot_duration_sec_(1.)
        {
        }
